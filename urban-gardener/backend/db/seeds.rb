...
listing1 = Listing.create(title: 'Large Sunny Area in Kew Gardens - Perfect for Planting Produce', img_url: 'https://s3.amazonaws.com/homestratosphere/wp-content/uploads/2016/02/29182351/1-Backyard-Tree-Ideas-iStock.jpg', street_address: 'Dunkin Donuts', zip: '11415', sunlight_amount: '6-8 hours', desired_garden_type: 'vegetable', compensation_type: 'percentage of harvest', dollar_compensation_amount: 0, percentage_compensation_amount: 35, user_id: rochel.id, description: 'sunny spot great for growing vegetables')
listing2 = Listing.create(title: 'Small Partly Sunny Area in Kew Gardens - Perfect for Planting Herbs', img_url: 'https://www.pinderful.net/uploads/pins/2015/07/big/55d02426c1ee3358213bbe15861fd38b.jpeg', street_address: 'starbucks', zip: '11415', sunlight_amount: '4-6 hours', desired_garden_type: 'herb', compensation_type: 'percentage of harvest', dollar_compensation_amount: 0, percentage_compensation_amount: 50, user_id: adam.id, description: 'partly shady spot will grow beatiful herbs. specifically want basil, rosemary, and parsey, but there is room for many other herbs of gardeners choice')
